...
During the whole time working as developer I was curious to learn new things, but also trying to get a detailed understanding of the technologies I use. Nowadays I'm learning and using more JavaScript, [TypeScript](https://www.typescriptlang.org/) and [Node.js](https://nodejs.dev/) on the backend. In my spare time I'm currently refreshing my electrical engineering basics, fiddling around with embedded systems and microcontrollers ([Arduino Uno R3](https://docs.arduino.cc/hardware/uno-rev3), [ESP8622](https://www.espressif.com/en/products/socs/esp8266), etc) and doing some self studies by [reading](https://www.elektronik-kompendium.de/shop/buecher/elektronik-fibel) [various](https://www.aula-verlag.de/shop/grundlagen-der-elektrotechnik/) [books](https://www.ingenieur-buch.de/energiespeicher-fur-die-energiewende.html).
